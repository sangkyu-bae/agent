...
import { ADMIN_ENTRY_PATH } from '@/constants/adminNav';
...
const NAV_ITEMS = [
  ...
  { id: 'tasks', label: '작업', path: '/jobs', iconPath: 'M12 6v6h4.5m4.5 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z' },
...
const BOTTOM_ITEMS = [
  ...
  { label: '지식베이스', path: '/knowledge-bases', iconPath: 'M12 6.042A8.967 8.967 0 0 0 6 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 0 1 6 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 0 1 6-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0 0 18 18a8.967 8.967 0 0 0-6 2.292m0-14.25v14.25' },
    ...
    >
      ...
      <div className="border-t border-white/[0.06] px-3 py-2 space-y-0.5">
        {BOTTOM_ITEMS.map(({ label, path, iconPath }) => {
          // kb-management-ui D7: 상세 라우트(/knowledge-bases/:kbId)에서도 활성 유지
          const isActive =
            path &&
          ...
          <button
            ...
            className={`flex w-full items-center gap-3 rounded-xl px-3 py-2 text-[12.5px] transition-all ${
              location.pathname.startsWith('/admin')
                ? 'bg-white/[0.12] text-white'
                : 'text-violet-300/70 hover:bg-white/[0.07] hover:text-violet-200'
            }`}
          >
            <svg className="h-4 w-4 shrink-0" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
              <path
